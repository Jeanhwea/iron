...
public abstract class LogEntity {
  ...
  @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "LOGGER_ID")
  @SequenceGenerator(sequenceName = "LOG_ID", allocationSize = 1, name = "LOGGER_ID")
  ...
  @PreUpdate
  @PrePersist
  public void mesLogEntityCreateAndUpdateHook() {
  ...
  public boolean equals(Object o) {
    ...
    return id == logEntity.id
        && Objects.equals(validation, logEntity.validation)
        && Objects.equals(updateTime, logEntity.updateTime)
        && Objects.equals(updateUser, logEntity.updateUser);
  }
