...
@Entity
@Table(name = "TB_RSRC_AUXI_OUT")
public class AuxiOut extends MesEntity {

  // 出库状态
  @Column(name = "OUT_STATUS", length = 100)
  ...
  // 出库类别
  @Column(name = "OUT_CATE", length = 100)
  ...
  // 出库类型
  @Column(name = "OUT_TYPE", length = 100)
  ...
  // 出库标记
  @Column(name = "OUT_FLAG", length = 100)
